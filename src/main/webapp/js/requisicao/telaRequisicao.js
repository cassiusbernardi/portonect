...
function salvarItemRequisicao() {
    ...
    if (!descricaoItemRequisicao || !quantidadeItemRequisicao || !idUnidade) {
        toastr.options = {
            "closeButton": true,
            "debug": false,
            "progressBar": true,
    ...
    $.post(appURL + "requisicao/salvarItem",
        ...
        if (data.retornoBean.status == 1) {
            ...
            $("#descricaoItemRequisicaoTxt").val('');
            $("#unidadeItemRequisicaoTxt").val('');
            $("#quantidadeItemRequisicaoTxt").val('');
        } else {
            toastr.options = {
                "closeButton": true,
                "debug": false,
...
function enviarRequisicao(title, text) {
...
//function adicionarParticipanteRequisicao() {
//
//    var idRequisicao = $("#idRequisicaoTxt").val();
//    var descricaoRequisicao = $("#descricaoRequisicaoTxt").val();
//    var descricaoItemRequisicao = $("#descricaoItemRequisicaoTxt").val();
...
//        html += '<td>' + qtdItem + '</td>';
//        html += '<td>' + unidadeItem + '</td>';
//        html += '<td><a title="Excluir" href="JavaScript:excluirItem(' + idItem + ')"><i class="glyphicon glyphicon-trash"></i></a></td>';
//        html += '</tr>';
//        $('#itemRequisicaoTbl').append(html);
//    }
//    $('[data-toggle="tooltip"]').tooltip();
