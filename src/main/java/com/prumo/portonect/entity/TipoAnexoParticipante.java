 ...
 */
@Entity
@Table(name="TB_TIPO_ANEXO_PARTICIPANTE")
public class TipoAnexoParticipante implements Serializable {

    private static final long serialVersionUID = 1L;
    
    @Id @Column(name="ID_TIPO_ANEXO_PARTICIPANTE") @GeneratedValue(strategy = GenerationType.IDENTITY)
